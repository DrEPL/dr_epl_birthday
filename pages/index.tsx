        ...
        <div className="text-center mb-8 sm:mb-12">
          <div className="relative inline-block group">
            ...
            <div className="relative">
              <div className="w-24 h-24 sm:w-32 sm:h-32 md:w-40 md:h-40 overflow-clip rounded-full mx-auto border-4 border-yellow-400 shadow-2xl transform hover:scale-150 transition-all duration-500 bg-gradient-to-br from-yellow-400 to-amber-600 flex items-center justify-center">
                <img src="drepl.jpg" alt="dr_epl" />
              </div>
            </div>
          </div>
